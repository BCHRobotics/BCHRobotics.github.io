...
.cyber-grid {
  ...
  inset: 0;
  z-index: 0;
  background: linear-gradient(rgba(255,60,60,.07) 1px, transparent 1px),
              linear-gradient(90deg, rgba(255,60,60,.07) 1px, transparent 1px);
...
.repo-card {
  ...
  z-index: 10;
  margin: 1rem;
  padding: 1rem 1rem 200px 1rem; /* bottom padding reserves tooltip space */
}
.repo-card:hover {
  box-shadow: 0 0 40px rgba(255,60,60,.8);
...
.robot-info {
  position: absolute;
  bottom: 20px; /* positions inside card's padding space */
  left: 50%;
  ...
  font-size: .85rem;
  border-radius: 1rem;
  box-shadow: 0 25px 50px rgba(255,60,60,.6);
  z-index: 100;
}
.repo-card:hover .robot-info {
  opacity: 1;
  visibility: visible;
...
<body>
  ...
  <main class="container">
    <header class="hero">
      <img src="img/trojan_title.png" alt="Team 2386 Trojan Logo" loading="lazy">
      <p>This is the official programming documentation hub for FRC Team 2386. While this isn't our main team website, it's where we host code, notes, and experiments related to robot programming.</p>
    ...
    <section id="repos">
      ...
      <div class="grid">
        ...
        <article class="repo-card">
          <h3>TankBot</h3>
          <img src="img/tankbot.png" width="200" alt="TankBot" loading="lazy">
          <div class="robot-info">
            <p>SYSTEM: TankBot</p>
            <p>MODE: Training / Drivetrain Testing</p>
        ...
        <article class="repo-card">
          <h3>MiniBot</h3>
          <img src="img/minibot.png" width="200" alt="MiniBot" loading="lazy">
          <div class="robot-info">
            <p>SYSTEM: MiniBot</p>
            <p>MODE: Prototyping / Sensors</p>
        ...
        <article class="repo-card">
          ...
          <img src="img/2025.png" width="200" alt="2025 Robot" loading="lazy">
          <div class="robot-info">
            <p>SYSTEM: 2025 Robot</p>
            <p>MODE: Competition</p>
        ...
        <article class="repo-card">
          ...
          <img src="img/2024.png" width="200" alt="2024 Robot" loading="lazy">
          <div class="robot-info">
            <p>SYSTEM: 2024 Robot</p>
            <p>MODE: Competition</p>
  ...
  <footer class="container">
    <small>© Team 2386 • Programming Documentation Hub</small>
  </footer>
